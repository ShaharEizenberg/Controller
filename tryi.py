...
class Mywin(wx.Frame):
    ...
    def InitUI(self):
        ...
        tb.AddTool(101, wx.Bitmap("sharing.png"))
        #tb.AddTool(102, wx.Bitmap("save.png"))

        right = tb.AddRadioTool(222, wx.Bitmap("no-internet.png"))
        center = tb.AddRadioTool(333, wx.Bitmap("power-off.png"))
        justify = tb.AddRadioTool(444, wx.Bitmap("sharing.png"))
